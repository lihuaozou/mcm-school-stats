...
- 为已知学校提供中文名映射，可直接搜索 `北京大学`、`清华大学`、`浙江大学` 等中文名称。
...
- 已映射中文名的记录：30,242 条。
- 已映射中文名的学校：548 所（按规范化学校名统计）。
- 使用官方证书补全/核验了 173 条学校名记录，详见 `data/certificate_institution_checks.csv`。
- 仍未补中文名且英文学校名可见的记录：1,503 条，详见 `data/missing_chinese_names.csv`。
